...
public: // public video interface
    auto setPalettes(const uint8_t* palettes) -> void;
    ...
    auto drawPolygon(const uint8_t* buffer, uint16_t offset, uint16_t zoom, const Point& point) -> void;
...
private: // private interface
    ...
    auto readAndDrawPolygon(uint8_t color, uint16_t zoom, const Point& point) -> void;

    auto fillPolygon(uint16_t color, uint16_t zoom, const Point& pt) -> void;

    auto drawChar(char character, uint16_t x, uint16_t y, uint8_t color, uint8_t* buffer) -> void;

    auto drawPoint(uint8_t color, int16_t x, int16_t y) -> void;

    auto drawLineBlend(int16_t x1, int16_t x2, uint8_t color) -> void;

    auto drawLineN(int16_t x1, int16_t x2, uint8_t color) -> void;

    auto drawLineP(int16_t x1, int16_t x2, uint8_t color) -> void;
